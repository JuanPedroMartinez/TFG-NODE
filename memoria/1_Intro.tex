...
\hilight{Faltaría decir resumido qué se quiere, más o menos repetir lo
  mismo que en el resumen. En este proyecto se quiere hacer una aplicación
  que facilite a los profesores gestionar los respositorios git de los
  alumnos, donde se pueden tener varias asignaturas, etc.}
